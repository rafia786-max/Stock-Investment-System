...
A simple Java application for tracking a stock portfolio — buy and sell shares, view your holdings, and see your profit/loss, all backed by plain CSV files. Comes with both a console interface and a Swing GUI.
